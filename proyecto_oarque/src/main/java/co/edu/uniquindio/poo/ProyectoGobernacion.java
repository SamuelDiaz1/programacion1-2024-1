...
public class ProyectoGobernacion {
    private Collection<ProyectoParqueInfantil> parques;
     ...
     */
    public void addParqueInfantil(ProyectoParqueInfantil parqueInfantil) {
     ...
     */
    public ProyectoParqueInfantil getParque(String nombre) {
        Predicate<ProyectoParqueInfantil> nombreIgual = parque -> parque.getNombre().equals(nombre);
     ...
     */
    public Collection<ProyectoParqueInfantil> getParquesMunicipio(String municipio) {
        var comparador = Comparator.comparing(ProyectoParqueInfantil::getNombre);
     ...
     */
    public Collection<ProyectoParqueInfantil> getParquesOrdenValorAscendete() {
        var comparador = Comparator.comparing(ProyectoParqueInfantil::calcularValor);
        var parquesOrdenados = parques
                .stream()
                .sorted(comparador)
                .toList();
